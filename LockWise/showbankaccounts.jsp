                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="fetchbankaccounts">Home</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="modal-dialog modal-lg" style="height:500px !important;" role="document">     
            <div class="modal-content">
                ...
                <div class="modal-header text-center" style="background-color:#FF2400">
                  <h4 class="modal-title w-100" style="font-weight: 150px; font-size: 20px;">----- Bank Account -----</h4>
                                ...
                                <tr>
                                   <th>Bank Name</th>
                                    <td>
                                        ...
                                        <p class="form-control"> <%=u.get(i).bankname %> </p>
                                        </div>
                                    </td> 
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).ifsc %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).type %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).acholder %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).acnumber %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).brname %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    <th>Branch Address</th>
                                    <td><div class="md-form mb-6">
                                    <div class="form-group">
                                    <p class="form-control"> <%=u.get(i).braddr %> </p>
                                    </div>
                                    </div></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).brphone %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).acdate %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
