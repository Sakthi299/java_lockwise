     ...
     <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">     
            <div class="modal-content">
                <form action="addpasswords">
                <div class="modal-header text-center" style="background-color:#FF2400">
                  <h4 class="modal-title w-100" style="font-weight: 150px; font-size: 20px;">Save Password</h4>
                        ...
                        <div class="col-md-6">  
                            <div class="md-form mb-6">
                                <div class="form-group has-icon">
                                    ...
                                    <input type="text" class="form-control" placeholder="Site Password">
                                </div>
                            </div>
                        </div>
                    </div>
