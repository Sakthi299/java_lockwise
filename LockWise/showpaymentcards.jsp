                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="fetchpaymentcards">Home</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="modal-dialog modal-lg" style="height:500px !important;" role="document">     
            <div class="modal-content">
                ...
                <div class="modal-header text-center" style="background-color:#FF2400">
                  <h4 class="modal-title w-100" style="font-weight: 150px; font-size: 20px;">----- Payment Card -----</h4>
                        ...
                        <div class="col-md-8">
                            ...
                            <tbody>
                                <tr>
                                   <th>Name on Card</th>
                                    <td>
                                        ...
                                        <p class="form-control"> <%=u.get(i).cardname %> </p>
                                        </div>
                                    </td> 
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).cardno %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-8">
                                            <p class="form-control"> <%=u.get(i).exmonth %> </p>
                                            </div>
                                      <div class="form-group col-md-4">
                                      <p class="form-control"> <%=u.get(i).exyear %> </p>
                                      </div>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).cvv %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
