        ...
        <div class="modal-dialog modal-lg" role="document">     
            <div class="modal-content">
                ...
                <div class="modal-header text-center" style="background-color:#FF2400">
                  <h4 class="modal-title w-100" style="font-weight: 150px; font-size: 20px;">Add secure note</h4>
                        ...
                        <div class="col-md-12">
                            <div class="md-form mb-6">
                                <div class="form-group has-icon">
                                    ...
                                    <textarea type="text" id="form8" class="md-textarea form-control" rows="8"></textarea>
                                </div>
                            </div>
                        </div>
                  </div>
