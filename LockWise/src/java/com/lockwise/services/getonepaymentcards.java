...
public class getonepaymentcards extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try (Connection conn = dbconnect.initializeDatabase()) {
                ...
                String query= "SELECT * from paymentcards where payid = ?";
                ...
                request.getRequestDispatcher("showpaymentcards.jsp").forward(request, response);
            }
            catch(Exception e)
            {
