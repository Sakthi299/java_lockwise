...
public class getonebankaccounts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             try (Connection conn = dbconnect.initializeDatabase()) {
                ...
                String query= "SELECT * from bankaccounts where accid = ?";
                ...
                request.getRequestDispatcher("showbankaccounts.jsp").forward(request, response);
            }
            catch(Exception e)
            {
