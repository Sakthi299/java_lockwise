                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="fetchaddresses">Home</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="modal-dialog modal-lg" style="height:500px !important;" role="document">     
            <div class="modal-content">
                ...
                <div class="modal-header text-center" style="background-color:#FF2400">
                  <h4 class="modal-title w-100" style="font-weight: 150px; font-size: 20px;">----- Address -----</h4>
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="form-group has-icon">
                                    ...
                                    <p class="form-control"> <%=u.get(i).name %> </p>
                                </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="form-control"> <%=u.get(i).first %> </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).last %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).gender %> </p></div>
                                    </td>
                                </tr>  
                                <tr>
                                    <th>Address 1</th>
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).addr_1 %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).addr_2 %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).city %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).country %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).state %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).zip %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <p class="form-control"> <%=u.get(i).email %> </p>
                                        </div>
                                    </td>
                                </tr>  
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <p class="form-control"> <%=u.get(i).phone %> </p>
                                        </div>
                                    </td>
                                </tr>  
                            </tbody>
